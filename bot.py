...
async def unified_callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 1. Entry point choice (/settings in group)
    ...
    # 4. Admin Check & Chat ID resolution
    ...
    # 6. SEE PREVIEWS (WELCOME / GOODBYE / CAPTCHA)
